...
/*Variables for validation of password*/
var formRegisterFirstPassword = document.getElementById("psw");
...
formRegisterFirstPassword.onfocus = function() {
  document.getElementById("message").style.display = "block";
}

// When the user clicks outside of the password field, hide the message box
formRegisterFirstPassword.onblur = function() {
  document.getElementById("message").style.display = "none";
}

// When the user starts to type something inside the password field
formRegisterFirstPassword.onkeyup = function() {
  // Validate lowercase letters
  var lowerCaseLetters = /[a-z]/g;
  if(formRegisterFirstPassword.value.match(lowerCaseLetters)) {
  ...
  if(formRegisterFirstPassword.value.match(upperCaseLetters)) {
  ...
  // Validate numbers
  var numbers = /[0-9]/g;
  if(formRegisterFirstPassword.value.match(numbers)) {
  ...
  // Validate length
  if(formRegisterFirstPassword.value.length >= 8) {
